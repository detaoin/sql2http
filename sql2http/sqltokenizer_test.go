...
var testcases = []struct {
	...
	{
		"SELECT /* comment /* nested */ ... */ \"me\"\"quoted\" FROM them \t-- comment\n'a string''with quote' + 0.12e-5+.012",
		[]item{
			item{typ: itemIdentifier, val: "SELECT"},
			item{typ: itemSpace, val: " "},
			item{typ: itemBlockComment, val: "/* comment /* nested */ ... */"},
			item{typ: itemSpace, val: " "},
			item{typ: itemQuotedIdentifier, val: "\"me\"\"quoted\""},
			item{typ: itemSpace, val: " "},
			...
			item{typ: itemStringLiteral, val: "'a string''with quote'"},
			item{typ: itemSpace, val: " "},
	...
	},
	{
		`"string""" '''string'`,
		[]item{
			item{typ: itemQuotedIdentifier, val: `"string"""`},
			item{typ: itemSpace, val: " "},
			item{typ: itemStringLiteral, val: `'''string'`},
		},
	},
}
